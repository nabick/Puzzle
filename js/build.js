...
let dibujaFicha = function dibujaFicha(fila, columna) {
        ...
        for (var i in direcciones) {
            ...
            //  console.log(i + " ocupado: " + matrizDesorganiza[posBusca.fila][posBusca.columna].ocupado);
                if (!matrizDesorganiza[posBusca.fila][posBusca.columna].ocupado) {
                  console.log("Hay espacio" + " " + i + " en la posición");
                  console.log(posBusca.fila) + console.log(posBusca.columna);

                  dibujaFicha(fila, columna);
                }
                /*else if (i = true) {
